...
## NOTE BEFORE RUNNING
# If you get errors loading the libraries:
#   Run these lines below (without #) to install the packages:
#os.system("lxterminal -e 'bash -c \"easy_install geopy; exec bash\"'")
#os.system("lxterminal -e 'bash -c \"easy_install twython; exec bash\"'")
#etc.

#   or in the terminal itself by:
# easy_install geopy
...
for j,k in enumerate(x):
    ...
    w.record(k,y[j],city[j],extra[j]) #write the attributes
